...
export default function App() {
  ...
  const getFilteredTransactions = () => {
    ...
    if (filterOptions.dateRange !== 'all') {
      ...
      filtered = filtered.filter(tx => {
        ...
        if (filterOptions.dateRange === 'today') return txDate.getTime() === today.getTime()
    ...
    if (filterOptions.minAmount || filterOptions.maxAmount) {
      filtered = filtered.filter(tx => {
        ...
        const min = filterOptions.minAmount ? parseFloat(filterOptions.minAmount) : 0
        const max = filterOptions.maxAmount ? parseFloat(filterOptions.maxAmount) : Infinity
  ...
  return (
    <div>
        ...
        <div className="card transaction-section">
          <div className="card-header">
            ...
            <div className="filters">
              <button className="filter-btn" onClick={() => setShowFilterModal(true)}><i className="fas fa-filter"></i> Filter</button>
            </div>
          </div>
      ...
      {showFilterModal && (
        <div className="Modal" onClick={(e) => { if (e.target.className === 'Modal') setShowFilterModal(false) }}>
          <div className="modal-content">
            <div className="modal-header">
            ...
            <div className="modal-body">
              <div className="form-group">
                ...
                <select className="form-select" value={filterOptions.type} onChange={e => setFilterOptions({...filterOptions, type: e.target.value})}>
              ...
              <div className="form-group">
                <label className="form-label">Category</label>
                <select className="form-select" value={filterOptions.category} onChange={e => setFilterOptions({...filterOptions, category: e.target.value})}>
              ...
              <div className="form-group">
                ...
                <select className="form-select" value={filterOptions.dateRange} onChange={e => setFilterOptions({...filterOptions, dateRange: e.target.value})}>
              ...
              <div className="form-group">
                ...
                <input type="number" className="form-input" value={filterOptions.minAmount} onChange={e => setFilterOptions({...filterOptions, minAmount: e.target.value})} placeholder="Min amount (optional)" />
              </div>

              <div className="form-group">
                <label className="form-label">Max Amount</label>
                <input type="number" className="form-input" value={filterOptions.maxAmount} onChange={e => setFilterOptions({...filterOptions, maxAmount: e.target.value})} placeholder="Max amount (optional)" />
              </div>
            </div>
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={() => {
                setFilterOptions({ category: 'all', dateRange: 'all', type: 'all', minAmount: '', maxAmount: '' })
                setShowFilterModal(false)
              }}>Clear All</button>
              <button className="btn btn-primary" onClick={() => setShowFilterModal(false)}>Apply Filter</button>
            </div>
          </div>
        </div>
      )}
